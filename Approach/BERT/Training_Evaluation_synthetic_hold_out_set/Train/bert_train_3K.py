...
path_input = "/local/users/ulede/BERT/labelled_text/train_3K/"
...
torch.save(model, "/local/users/ulede/BERT/model_3K.pth")
...
myfile = open("/local/users/ulede/BERT/" + "tag_values_3K", "w",encoding="utf-8")
myfile.write(output_text)
myfile.close()
end_time = time.time()
time_elapsed = (end_time - start_time)
print("Dauer in min: "+ str(time_elapsed/60))
myfile = open("/local/users/ulede/BERT/" + "time_3k.txt", "w",encoding="utf-8")

...
tag_values = open("/local/users/ulede/BERT/tag_values_2K","r",encoding="utf-8")
...
model = torch.load("/local/users/ulede/BERT/model_2K.pth")
...
myfile = open("/local/users/ulede/BERT/" + "eval_2K.txt", "w",encoding="utf-8")

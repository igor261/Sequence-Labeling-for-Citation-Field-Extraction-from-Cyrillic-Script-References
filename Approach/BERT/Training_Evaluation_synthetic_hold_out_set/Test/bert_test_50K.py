...
tag_values = open("/local/users/ulede/BERT/tag_values_50K","r",encoding="utf-8")
...
model = torch.load("/local/users/ulede/BERT/model_50K.pth")
...
myfile = open("/local/users/ulede/BERT/" + "eval_50K.txt", "w",encoding="utf-8")

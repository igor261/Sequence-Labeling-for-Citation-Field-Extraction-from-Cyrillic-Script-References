...
tag_values = open("/local/users/ulede/BERT/tag_values_1K","r",encoding="utf-8")
...
model = torch.load("/local/users/ulede/BERT/model_1K.pth")
...
myfile = open("/local/users/ulede/BERT/" + "eval_1K.txt", "w",encoding="utf-8")

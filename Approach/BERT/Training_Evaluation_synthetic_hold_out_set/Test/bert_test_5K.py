...
tag_values = open("/local/users/ulede/BERT/tag_values_5K","r",encoding="utf-8")
...
model = torch.load("/local/users/ulede/BERT/model_5K.pth")
...
myfile = open("/local/users/ulede/BERT/" + "eval_5K.txt", "w",encoding="utf-8")

...
tag_values = open("/local/users/ulede/BERT/tag_values_10K","r",encoding="utf-8")
...
model = torch.load("/local/users/ulede/BERT/model_10K.pth")
...
myfile = open("/local/users/ulede/BERT/" + "eval_10K.txt", "w",encoding="utf-8")

...
tag_values = open("/local/users/ulede/BERT/tag_values_3K","r",encoding="utf-8")
...
model = torch.load("/local/users/ulede/BERT/model_3K.pth")
...
myfile = open("/local/users/ulede/BERT/" + "eval_3K.txt", "w",encoding="utf-8")

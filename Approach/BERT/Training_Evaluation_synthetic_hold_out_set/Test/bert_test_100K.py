...
tag_values = open("/local/users/ulede/BERT/tag_values_100K","r",encoding="utf-8")
...
model = torch.load("/local/users/ulede/BERT/model_100K.pth")
...
myfile = open("/local/users/ulede/BERT/" + "eval_100K.txt", "w",encoding="utf-8")

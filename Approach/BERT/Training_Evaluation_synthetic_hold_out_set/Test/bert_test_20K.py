...
tag_values = open("/local/users/ulede/BERT/tag_values_20K","r",encoding="utf-8")
...
model = torch.load("/local/users/ulede/BERT/model_20K.pth")
...
myfile = open("/local/users/ulede/BERT/" + "eval_20K.txt", "w",encoding="utf-8")

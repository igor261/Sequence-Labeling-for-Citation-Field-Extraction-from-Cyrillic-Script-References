...
y_actu = pd.Series(real_label_eval, name='Actual')
y_pred = pd.Series(new_label_eval, name='Predicted')
...
myfile = open("/local/users/ulede/BERT/final_model/" + "confusionmatrix.txt", "w",encoding="utf-8")#".\Sequence-Labeling-for-Reference-Parsing-of-Cyrillic-Script-Scholarly-Data\BERT\BERT_final_model\confusionmatrix
myfile.write(str(df_confusion))
myfile.close()